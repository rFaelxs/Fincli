...
public class TransacaoService {
   ...
   * {@link ReservaService}. Como cada mutação regrava o documento inteiro, dois serviços
   ...
   */
  public TransacaoService(UsuarioRepository repository, UUID idUsuario, DadosUsuario dados) {
